...
from basicts.DADiffNet.dadiffnet import DADiffNet
...
# ================= general ================= #
CFG.DESCRIPTION = "DADiffNet model configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "DADiffNet"
CFG.MODEL.ARCH = DADiffNet
adj_mx, _ = load_adj("datasets/" + CFG.DATASET_NAME +
                     "/adj_mx.pkl", "doubletransition")

adj_mx_ori, _ = load_adj("datasets/" + CFG.DATASET_NAME +
                     "/adj_mx.pkl", "original")
