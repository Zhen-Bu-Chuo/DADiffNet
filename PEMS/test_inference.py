...
def parse_args():
    ...
    parser.add_argument('-c', '--cfg', default='config/PEMS08.py',
                        help='training config')
    parser.add_argument('--ckpt',default='checkpoints/DADiffNet_200/3a1bd22327e6fdc43e7a31e7c53d4bc8/DADiffNet_best_val_MAE.pt',
